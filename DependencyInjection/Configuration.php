...
class Configuration implements ConfigurationInterface
{
    ...
    /** @var string */
    const DEFAULT_BOOTSTRAP_OUTPUT = '%kernel.project_dir%/src/Resources/less/bootstrap.less';

    /** @var string */
    const DEFAULT_BOOTSTRAP_OUTPUT_SASS = '%kernel.project_dir%/src/Resources/sass/bootstrap.scss';
